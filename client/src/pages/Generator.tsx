  ...
  return (
    ...
    <form onSubmit={handleGenerate} className="max-w-4xl mx-auto mb-40">
        ...
        <div className="flex gap-20 max-sm:flex-col items-start justify-between">
            {/* Left col */}
            <div className="flex flex-col w-full sm:max-w-60 gap-11 mt-9 mb-12 ">
        ...
        <div className="flex justify-center mt-10">
            <PrimaryButton disabled={isGenerating} className="w-full px-10 py-3 rounded-md disabled:opacity-70 disabled:cursor-not-allowed">
                {isGenerating ? (
                <>
